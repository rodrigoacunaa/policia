                        ...
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Listado de trabajos</h5>  
                                    <!-- Product price-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Fechas asignadas para calificaciones</h5>  
                                    <!-- Product price-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Planillas de calificaciones</h5>  
                                    <!-- Product price-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Planilla notas finales de conductas</h5>  
                                    <!-- Product price-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Planilla de inasistencias</h5>  
                                    <!-- Product price-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Actas de examen</h5>  
                                    <!-- Product price-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Cierre primer llamado a examen</h5>  
                                    <!-- Product price-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-10">              
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Orden de merito </h5>  
                                    <!-- Product price-->
